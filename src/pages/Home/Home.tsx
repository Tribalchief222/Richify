        ...
        schema={[
          {
            ...
            schema: [
              {
                type: 'typography',
                label: "Welcome to the Risk Profile Survey by RichifyTM. We will ask you 10 questions, should take about 5-6 minutes. There are no right or wrong responses to these questions. You know yourself the best! Are you ready?",
                key: 'typography'
              }
            ],
            onNext: async (values) => {
          ...
          },
          {
            ...
            schema: [
              {
                type: 'radio',
                label: '4.How would you react in the  following scenarios? (a) if your investments fall by 20% due to a market-wide downturn?',
                key: 'radio',
                options: [
                  {
          ...
          },
          {
            ...
            schema: [
              {
                type: 'radio',
                label: "4. How would you react in the following scenarios? (b) If your investments fall by 20% due to issues specific to the sector you’re holding? ",
                key: 'radio',
                options: [
                  {
                    value: 'Sell all my investments'
          ...
          },
          {
            ...
            schema: [
              {
                type: 'radio',
                label: "6. How do you feel about potentially losing money in the short term for the possibility of higher returns in the long term?  ",
                key: 'radio',
                options: [
                  {
          ...
          },
          {
            ...
            schema: [
              {
                type: 'radio',
                label: "7. How important is it to for you to preserve your capital, even if it means potentially lower returns? ",
                key: 'radio',
                options: [
                  {
          ...
          },
          {
            ...
            schema: [
              {
                type: 'radio',
                label: "9. In terms of your financial situation, how much can you afford to lose without affecting your standard of living? ",
                key: 'radio',
                options: [
                  {
                    value: 'Nothing'
